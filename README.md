...
**v0.2.1-beta.15 is the current private-beta daily driver.** The authenticated
...
```console
$ cargo install chordrift --version 0.2.1-beta.15 --locked --force
```

Read the [v0.2.1-beta.15 release notes](docs/releases/V0.2.1-beta.15.md), the
