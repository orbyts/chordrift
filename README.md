...
**v0.2.1-beta.17 is the current private-beta daily driver.** The authenticated
...
```console
$ cargo install chordrift --version 0.2.1-beta.17 --locked --force
```

Read the [v0.2.1-beta.17 release notes](docs/releases/V0.2.1-beta.17.md), the
