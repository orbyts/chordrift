...
**v0.2.1-beta.14 is the current private-beta daily driver.** The authenticated
...
```console
$ cargo install chordrift --version 0.2.1-beta.14 --locked --force
```

Read the [v0.2.1-beta.14 release notes](docs/releases/V0.2.1-beta.14.md), the
